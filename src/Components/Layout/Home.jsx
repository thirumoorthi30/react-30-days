...
const projects = [
  ...
  { day: "05", title: "Digital Clock", path: "/digital-clock" },
  { day: "06", title: "Joke App", path: "/joke-app" },
  { day: "07", title: "Weather App", path: "/weather-app" },
];

export default function Home() {
  return (
    <div className="min-h-[75vh] p-6 bg-[var(--bg)] text-[var(--text)]">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
        {projects.map((p) => (
          <Link
            key={p.day}
            to={p.path}
            className="block p-6 bg-[var(--bg)] hover:bg-gray-200 dark:hover:bg-gray-800 shadow-md rounded-xl hover:shadow-xl hover:-translate-y-1 transition transform duration-300"
          >
